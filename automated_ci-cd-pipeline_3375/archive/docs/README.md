...
2) Jenkins/Maven/Ansible
    ...
    - User data (Copy the following user data): https://github.com/prajwaldhone/Automated_CI-CD_Pipleline_3375/blob/maven-nexus-sonarqube-jenkins-install/jenkins-install.sh
    - Launch Instance
...
3) SonarQube
    ...
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/prajwaldhone/Automated_CI-CD_Pipleline_3375/blob/maven-nexus-sonarqube-jenkins-install/sonarqube-install.sh
    - Launch Instance
...
4) Nexus
    ...
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/prajwaldhone/Automated_CI-CD_Pipleline_3375/blob/maven-nexus-sonarqube-jenkins-install/nexus-install.sh
    - Launch Instance
...
### Configure Promitheus
  ...
  - Change directory to "Automated_CI-CD_Pipleline_3375"
...
- **NOTE(MANDATORY):** Once you login to the splunk Indexer
    ...
    - **IMPORTANT:** Navigate Back to your `Terminal` where you're `Configuring the Indexer`
        ...
        ![SplunkSetup4!](https://github.com/prajwaldhone/Automated_CI-CD_Pipleline_3375/blob/zdocs/images/Screen%20Shot%202023-07-02%20at%209.50.16%20PM.png)
