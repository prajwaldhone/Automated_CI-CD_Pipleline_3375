# End-to-End Jenkins CI/CD Pipeline Phttps://github.com/prajwaldhone/Automated_CI-CD_Pipleline_3375.gitroject (Arch)
...
1) Create a GitHub Repository with the name `Jenkins-Realworld-CICD-Project` and push the code in this branch(main) to 
    ...
    ![ProjectRepositoryCode!]![WhatsApp Image 2025-04-06 at 21 41 28_1c8b2e31](https://github.com/user-attachments/assets/117ac1ba-896d-48b5-a2be-a3b5b09da74c)
...
5) Nexus
    ...
    - User data (Copy the following user data): https://github.com/prajwaldhone/Automated_CI-CD_Pipleline_3375/blob/maven-sonarqube-nexus-jenkins-install/nexus-install-t2large.sh
    - Launch Instance
...
### Configure Promitheus With (Service Discovery)
  ...
  - Clone repository: `git clone https://github.com/prajwaldhone/Automated_CI-CD_Pipleline_3375.git`
  - Change directory: `cd Automated_CI-CD_Pipleline_3375`
...
### Open a New Tab on your browser for Grafana also if you've not done so already. 
  ...
  - Once the UI Opens pass the following username and password
      ...
      - New Password: `admin`
      - Click on `Submit`
  ![ConfigureGrafana!](https://github.com/prajwaldhone/Automated_CI-CD_Pipleline_3375/blob/zdocs/images/sagdsgfsa.png)
  ...
  ![GrafanaMetrics!](https://github.com/prajwaldhone/Automated_CI-CD_Pipleline_3375/blob/zdocs/images/fwefwrfwrsgvsd.png)
...
![SplunkSetup4!](https://github.com/prajwaldhone/Automated_CI-CD_Pipleline_3375/blob/zdocs/images/fwefwrfwrsgvsdsd.png) 
...
3)  #### Global tools configuration:
    ...
    ![JDKSetup!](https://github.com/prajwaldhone/Automated_CI-CD_Pipleline_3375/blob/zdocs/images/sdsdsdsdsd.png)
    ...
    - **JDK** 
        ...
        **Note:** By default the **Install Oracle Java SE Development Kit from the website** make sure to close that option by clicking on the image as shown below.
        ...
        ![JDKSetup!](https://github.com/prajwaldhone/Automated_CI-CD_Pipleline_3375/blob/zdocs/images/dsdsdsdsdsd.png)
...
2)  ### Setup SonarQube GateKeeper
    ...
    ![SonarQubeSetup2!](https://github.com/prajwaldhone/Automated_CI-CD_Pipleline_3375/blob/zdocs/images/dsdsdsdsdsdsds.png)
    ...
    ![SonarQubeSetup3!](https://github.com/prajwaldhone/Automated_CI-CD_Pipleline_3375/blob/zdocs/images/SDFVDSFVDFV.png)
...
- Test your Pipeline to `Make Sure That The Artifacts Upload Stage Succeeds` including the `Deployments`.
    ...
    - Click on `Build Now`
![PipelineStagesArtifactSuccess!](https://github.com/prajwaldhone/Automated_CI-CD_Pipleline_3375/raw/zdocs/images/Screen%20Shot%202023-04-27%20at%204.44.30%20PM.png)
...
![FinalProductDisplay!](https://github.com/prajwaldhone/Automated_CI-CD_Pipleline_3375/blob/zdocs/images/SDFVDSFVDFVsdsd.png)
